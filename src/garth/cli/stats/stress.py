...
from garth.stats import DailyStress, WeeklyStress


app = typer.Typer(help="Stress stats.")
...
def daily(
    ...
    _resume(ctx)
    _dump_list(DailyStress.list(end=end, period=days))
...
def weekly(
    ...
    _resume(ctx)
    _dump_list(WeeklyStress.list(end=end, period=days))
