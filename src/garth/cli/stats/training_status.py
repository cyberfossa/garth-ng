...
app = typer.Typer(help="Training status stats.")
...
def daily(
    ...
    _resume(ctx)
    _dump_list(DailyTrainingStatus.list(end=end, period=days))
...
def weekly(
    ...
    _resume(ctx)
    _dump_list(WeeklyTrainingStatus.list(end=end, period=days))
...
def monthly(
    ...
    _resume(ctx)
    _dump_list(MonthlyTrainingStatus.list(end=end, period=days))
