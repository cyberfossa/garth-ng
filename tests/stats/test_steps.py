...
def test_daily_steps(authed_client: Client, load_cassette):
    load_cassette(
        authed_client,
        "tests/stats/cassettes/test_daily_steps.yaml",
    )
    end = date(2023, 7, 20)
    days = 20
...
def test_weekly_steps(authed_client: Client, load_cassette):
    load_cassette(
        authed_client,
        "tests/stats/cassettes/test_weekly_steps.yaml",
    )
    end = date(2023, 7, 20)
    weeks = 52
